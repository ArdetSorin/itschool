 ...
 */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Are countryOne and countryTwo equal? " + countryOne.equals(countryTwo));

        countryTwo = "UK";

        System.out.println("Are countryOne and countryTwo equal after changing countryTwo? " + countryOne.equals(countryTwo));
    }
}